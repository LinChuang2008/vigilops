...
## NightMend 的做法：AI 分析 + 自动修复

我们在 NightMend 里尝试了一个不同的思路：让 AI（基于 DeepSeek）参与告警处理的全流程。
...
或者直接访问在线 Demo：[https://demo.lchuangnet.com](https://demo.lchuangnet.com)（账号 `demo@nightmend.io` / `demo123`，只读）
...
NightMend 是一个早期项目。我们不会假装它能解决所有告警疲劳问题——告警疲劳的根源既有技术层面，也有组织层面。

但我们相信一个方向：**监控系统不应该只会喊"着火了"，它也应该会灭火。** 至少对于那些常见的、可预期的问题，自动修复是一个值得尝试的解决方案。

如果你也被告警疲劳困扰，欢迎试用 NightMend，或者在 [GitHub Discussions](https://github.com/LinChuang2008/nightmend/discussions) 和我们交流你的经验。我们特别想听到：你的告警中，有多少比例是"看了但不需要操作的"？

---

*NightMend 是一个 Apache 2.0 开源项目。代码在 [GitHub](https://github.com/LinChuang2008/nightmend)。*
